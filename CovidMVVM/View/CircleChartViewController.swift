...
class CircleChartViewController: UIViewController, StoryboardInstantiatable {
    
    struct Dependency {
        let viewModel: CircleChartViewModelType!
    }
    
    func inject(_ dependency: CircleChartViewController.Dependency) {
        viewModel = dependency.viewModel
    }
    var viewModel: CircleChartViewModelType!
    let colors = Colors()
...
//MARK: ビュー
extension CircleChartViewController {
    func setView() {
    ...
    func dataSet() {
        ...
        let dataSet = PieChartDataSet(entries: viewModel.outputs.entries)
        dataSet.colors = [
